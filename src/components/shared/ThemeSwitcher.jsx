...
const THEMES = ['noble', 'dark', 'light', 'cupcake', 'business', 'synthwave', 'nord'];
const STORAGE_KEY = 'noble-trader-theme';
const THEME_CHANGE_EVENT = 'noble-trader-theme-change';
...
function getSnapshot() {
  return localStorage.getItem(STORAGE_KEY) || 'noble';
}
...
export default function ThemeSwitcher() {
  ...
  // Apply saved theme on first client render
    ...
    <div className="dropdown dropdown-end">
      <div tabIndex={0} role="button" className="btn btn-ghost min-w-[44px] min-h-[44px] sm:min-w-0 sm:min-h-0 sm:btn-sm btn-circle" aria-label="Change theme">
        <label className="swap swap-rotate">
          ...
          {/* Moon icon (shown in light themes) */}
