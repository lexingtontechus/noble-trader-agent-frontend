 ...
 *     stack traces.
 *  2. `getErrorDisplay()` — Maps known error patterns to polished,
...
const ERROR_MAP = [
  ...
  {
    pattern: /SUPABASE_SERVICE_ROLE_KEY|SUPABASE_ENCRYPTION_KEY|NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY|NEXT_PUBLIC_SUPABASE_URL|SUPABASE_URL/i,
...
const CONTEXT_MESSAGES = {
  ...
  campaign: "Unable to process campaign request. Please try again later.",
  trading: "Unable to process trade request. Please try again later.",
...
export function getErrorDisplay(code) {
  const displays = {
    ...
    [ErrorCodes.INTERNAL_ERROR]: {
      ...
      description: "An internal error occurred. Please try again, and contact support if the problem persists.",
      icon: "alert",
      action: "retry",
    },
    [ErrorCodes.VALIDATION_ERROR]: {
      title: "Validation Error",
      description: "The request contained invalid data. Please check your inputs and try again.",
      icon: "shield",
      action: "retry",
    },
    [ErrorCodes.UNKNOWN]: {
